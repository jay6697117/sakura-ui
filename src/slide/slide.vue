<template>
  <div class="s-slide">
    <div class="s-window" @mouseenter="pause" @mouseleave="start">
      <slot></slot>
      <s-icon name="left" class="ico prev" @click="onClickPrev"></s-icon>
      <s-icon name="right" class="ico next" @click="onClickNext"></s-icon>
    </div>
    <div class="s-dot">
      <span
